...
public class CourseRVAdapter extends RecyclerView.Adapter<CourseRVAdapter.ViewHolder> {
    ...
    // constructor
    public CourseRVAdapter(ArrayList<CourseModal> courseModalArrayList, Context context, OnItemClickListener listener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // Invoke the onItemClick method in the listener
                    listener.onItemClick(courseModalArrayList.get(getAdapterPosition()));
                }
            });
        }
    }
    ...
    public interface OnItemClickListener {
        void onItemClick(CourseModal modal);
        ;
    }
}
